    ...
    <div>
      <section className="py-8" id="contact">
        <div className="container mx-auto px-4">
          <div className="bg-[#cc2c32] rounded-lg p-6 md:p-8 text-white">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-xl md:text-3xl font-light mb-3">Pronto para garantir sua proteção?</h2>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-xs">
            <h3 className="text-lg font-light mb-4 text-center text-feijo-darkgray">Selecione o seu Consultor / Corretor:</h3>
