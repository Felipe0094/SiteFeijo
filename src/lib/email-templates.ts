...
const emailStyles = `
  ...
  .info-item .info-label { width: auto; display: block; }
  .info-item .info-value { display: block; }
...
export const generateAutoInsuranceEmailContent = (quoteData: any) => {
  ...
  const formatHomeGarageOption = (option: string) => {
    ...
    return optionMap[option] || 'Não informado';
  };
      ...
      <div class="info-section">
        ...
        <div class="info-grid">
          <div class="info-item">
            ...
            <div class="info-value">${formatHomeGarageOption(quoteData.home_garage_option)}</div>
          </div>
          <div class="info-item">
